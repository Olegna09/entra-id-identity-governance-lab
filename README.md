...
Gelo Retail Group is modernizing its Identity and Access Management (IAM) platform using Microsoft Entra ID to establish a centralized, policy-driven identity lifecycle.
...
![Architecture Diagram](Images/Project1_Thumbnail.jpg)
